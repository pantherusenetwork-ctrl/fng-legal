...
_PDF_PALETTES = {
    ...
    "kaki": {
        "bg": (0.047, 0.055, 0.024),   # #0c0e06
        "frame": (0.173, 0.192, 0.094),  # #2c3118
        "text": (0.831, 0.851, 0.722),   # #d4d9b8
        "dim": (0.498, 0.525, 0.388),    # #7f8663
        "accent": (0.922, 0.612, 0.078),  # #eb9c14
        "row_line": (0.118, 0.133, 0.063),  # #1e2210
    },
    "nuit": {
        ...
        "accent": (1.0, 0.478, 0.102),   # #ff7a1a
        "row_line": (0.055, 0.075, 0.110),
    },
}
_CARTOUCHE_H = 46
_MARGIN = 18
