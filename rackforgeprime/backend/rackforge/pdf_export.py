...
_PDF_PALETTES = {
    ...
    "kaki": {
        "bg": (0.082, 0.090, 0.051),   # #15170d
        "frame": (0.227, 0.259, 0.141),  # #3a4224
        "text": (0.859, 0.878, 0.773),   # #dbe0c5
        "dim": (0.561, 0.584, 0.447),    # #8f9572
        "accent": (0.910, 0.627, 0.125),  # #e8a020
        "row_line": (0.153, 0.176, 0.094),  # #272d18
    },
    "nuit": {
