...
PALETTES: dict[str, dict[str, str]] = {
    ...
    "pastel": {
        "bg": "#f2eff7", "frame": "#fbfafe", "rail": "#e2dcee",
        "hole": "#c8bedb", "slot": "#ece7f4", "slot_line": "#ddd5ea",
        "text": "#37324a", "dim": "#7d7694", "face": "#fdfcff",
        "accent": "#f0823c", "face_stroke": "#d6cde6", "pill": "#bfb4d4",
        "port_fill": "#fdfcff", "decor_fill": "#eae4f2",
        "decor_stroke": "#cdc2df", "ring": "#b3a7c9", "lcd": "#f6e8f0",
        "band": "#37324a",
    },
    "nuit": {
